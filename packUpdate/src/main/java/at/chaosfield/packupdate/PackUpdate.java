...
public class PackUpdate extends Application {
	...
	// the second parameter has to be the location of the local Pack Info CSV
	// file inside the modpack root and
	// the third parameter has to be the path to the modpack root where the mods
	// folder should go.
	...
	public void start(Stage primaryStage) throws Exception {
		...
		if (parameters.size() != 3) {
			errorAlert("Wrong Parameters", "Pack Updater was provided with the wrong Parameters",
	...
	public void initRootLayout() {
		try {
			...
			loader.setLocation(PackUpdate.class.getResource("/fxml/main.fxml"));
